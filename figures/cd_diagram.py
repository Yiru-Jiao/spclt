...
def graph_ranks(avranks, names, p_values, cd=None, cdmethod=None, lowv=None, highv=None,
    ...
    for i in range(math.ceil(k / 2)):
        ...
        line([(rankpos(ssums[i]), cline),
             ...
             linewidth=linewidth)
        if labels:
            text(textspace + 0.3, chei - 0.075, format(ssums[i], '.3f'), ha="right", va="center", size=12)
    ...
    for i in range(math.ceil(k / 2), k):
        ...
        line([(rankpos(ssums[i]), cline),
             ...
             linewidth=linewidth)
        if labels:
            text(textspace + scalewidth - 0.3, chei - 0.075, format(ssums[i], '.3f'), ha="left", va="center", size=12)
