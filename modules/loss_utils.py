...
@torch.compile(mode="reduce-overhead", fullgraph=True, dynamic=False)       # PT ≥ 2.6  :contentReference[oaicite:2]{index=2}
def relaxed_distortion_measure_JGinvJT(L, Y, node_chunk=128, k_chunk=256):
    """
