...
|    runs    |at most 4 |     2      |     2x3    |  5x3+4x5 |      2      |    2x3      |    <=53    |
-------------------------------------------------------------------------------------------------------
'''
...
def main(args):
    ...
    def save_best_params(best_param_log, tuned_phase, log_dir, best_score=None):
        ...
        if os.path.exists(log_dir): # previous log exists, append the new best params
            ...
            for key, value in tuned_params.items():
                ...
                if key == 'temporal_hierarchy':
                    value2log = str(value2log) if value2log is not None else 'None'
    ...
    for dataset in dataset_list:
        ...
        search_space = {'tau_inst': [1, 3, 5, 10, 20], # used in softclt study
                        ...
                        'bandwidth': [1., 4., 9.], # used in geometry regularizer only
